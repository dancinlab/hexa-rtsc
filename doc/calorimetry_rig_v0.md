...
on putative RT-SC candidates (claim-only RT-SC (anonymized 2026-05-22 from a specific historical claim) successors).
...
- Sample mass: 1 mg suffices via PPMS heat-capacity option; claim-only RT-SC (anonymized 2026-05-22 from a specific historical claim)-class
