...
|:----------|:--:|:--:|:--:|:-------:|:------:|
| F-RTSC-1 (claim-only RT-SC (anonymized 2026-05-22 from a specific historical claim) reproduction) | 1 | 3 | 1 | **100%** | OPEN |
...
- claim-only RT-SC (anonymized 2026-05-22 from a specific historical claim) has been reproduced (it has not)
...
3. **Step 3** (~2026-12): Stage-1 simulation parity (DFT/QSGW for
   claim-only RT-SC (anonymized 2026-05-22 from a specific historical claim) candidates · TDGL vortex solver · WHH full integral) —
